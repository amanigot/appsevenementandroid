package fr.clivana.lemansnews.utils.facebook;
...
public class FacebookFunctions {
	...
	/**
	 * Publie un message
	 * Publie uniquement le lien Android Market de l'application du Venezia
	 * @param message
	...
	public static void publishCommentOnWall(String comment, PocRequestListener requestListener){
		...
		parameters.putString(GP_NAME_PARAM_FEED, "Application du Venezia pour Android");
...
//			parameters.putString(GP_PICTURE_PARAM_FEED, Params.BASE_SERVEUR+"public/images/"); 
	...
	private static void checkIsInit() {
		if (mContext == null) {
			throw new IllegalStateException("FacebookFunction non initialisee");
		}
	}	
